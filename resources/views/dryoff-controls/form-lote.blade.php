...
<div class="container-fluid px-4">
    <h1 class="mt-4">Encerramento de Lactação do Rebanho - Lote</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item active">Processamento de Lote de Animais</li>
    </ol>
    @if(!count($animals))
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form id="form-lote" method="POST" action="{{ route('dryoff-controls.update-lote', $lote_id) }}">
