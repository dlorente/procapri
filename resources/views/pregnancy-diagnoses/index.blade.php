...
<div class="container-fluid px-4">
    <h1 class="mt-4">Diagnóstico de Prenhes</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item active">Diagnóstico de Prenhes</li>
    </ol>
    <div class="card mb-4">
        <div class="card-body">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <form method="GET" action="{{ route('pregnancy-diagnoses.index') }}">
                    ...
                    @forelse($animals as $animal)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('pregnancy-diagnoses.edit', $animal->cio_id) }}" class="btn btn-primary" title="Editar Animal">
                                ...
                                <form id="btn-delete-{{ $animal->cio_id }}" action="{{ route('pregnancy-diagnoses.destroy', $animal->cio_id) }}"
