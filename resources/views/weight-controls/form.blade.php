...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Formulário de Entrada de Peso do Animal</li>
    </ol>
    <div class="card mb-4">
        <div class="card-body">
            @if (! isset($weight_control))
                    <form method="POST" action="{{ route('weight-controls.store') }}">
            @else
                <form method="POST" action="{{ route('weight-controls.update', $weight_control) }}">
                    @method('PUT')
            @endif
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="ananimal" disabled value="{{ old('ananimal', $weight_control->animal->ananimal ?? null) }}">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="mb-3">
                                <label class="form-label">Nome do animal</label>
                                <input type="text" class="form-control" id="annome" disabled value="{{ old('annome', $weight_control->animal->annome ?? null) }}">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input autocomplete="off" type="text" class="datepicker date form-control @error('pedatapes') is-invalid @enderror" id="pedatapes" name="pedatapes" value="{{ old('pedatapes', $weight_control->pedatapes ?? null) }}">
                                    @error('pedatapes')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('pepeso') is-invalid @enderror" 
                                    ...
                                    value="{{ old('pepeso', $weight_control->pepeso ?? null) }}"
