...
return [
    ...
    */
    ...
    'attributes' => [
        'anentrada'         => 'data de entrada',
        'anregistro'        => 'número de registro',
        'andatasai'         => 'data de saída',
        'name'              => 'nome',
        'equipment_type_id' => 'tipo do equipamento',
        'customer_id'       => 'cliente',
        'password'          => 'senha',
        ...
        'code'              => 'código',
        'initials'          => 'sigla',
        'operating_base_id' => 'base operacional',
        ...
        'non_compliance_id' => 'não conformidade',
